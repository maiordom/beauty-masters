...
export default {
  ...
  favoriteEmpty: {
    ...
    text: 'Добавляйте мастеров в Избранное, нажав звездочку на экране мастера',
  },
  favorites: 'Избранное',
  ...
  forgotPassword: {
    error: 'Не удалось отправить письмо, попробуйте еще раз',
    question: 'Забыли пароль?',
    success: 'Отправили письмо с паролем на вашу почту',
    text: 'На этот адрес будет отправлено письмо со ссылкой для восстановления пароля',
  ...
  presentation: {
    ...
    title: 'Re:Lak - приложение по поиску мастеров маникюра и педикюра',
  },
  ...
  registrationComplete: {
    addCard: 'Добавить еще карточку мастера',
