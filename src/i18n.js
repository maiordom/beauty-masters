...
export default {
  ...
  forgotPwdText: 'На этот адрес будет отправлено письмо со ссылкой для восстановления пароля',
  forgotPwdSuccess: 'Отправили письмо с паролем на вашу почту',
  forgotPwdError: 'Не удалось отправить письмо, попробуйте еще раз',
  username: 'Имя',
  from: 'С',
  fromYou: 'От вас',
  km: 'км',
